  ...
  .directive('dndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
    ...
    return function(scope, element, attr) {
      ...
      element.on('dragend', function(event) {
        event = event.originalEvent || event;
        item  = scope.$eval(attr.dndDraggable);
        ...
        scope.$apply(function() {
          switch (dropEffect) {
            case "move":
              $parse(attr.dndMoved)(scope, {event: event, item: item});
              break;
            case "copy":
              $parse(attr.dndCopied)(scope, {event: event, item: item});
              break;
            case "none":
              $parse(attr.dndCanceled)(scope, {event: event, item: item});
              break;
          }
